...
%   [LSDYNA,MATERIAL] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [LSDYNA,MATERIAL] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [LSDYNA,MATERIAL] = importfile('out_001',7, 208);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/06/12 11:52:39
